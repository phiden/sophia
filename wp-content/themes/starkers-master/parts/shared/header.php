<header>
	...
	<li class="main-nav-logo"><a href="<?php echo home_url(); ?>">sophia <img src="http://localhost:8888/sophia/wp-content/themes/starkers-master/img/sd-medallion-pink.png"/> dengo&nbsp;&nbsp;</a></li>
	<nav>
